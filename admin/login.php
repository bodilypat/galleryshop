...
if(isset($_POST['login']))
  {
    ...
    $qAdmin=mysqli_query($con,"SELECT ID FROM tbladmin WHERE  UserName='$adminuser' && Password='$password' ");
    $result=mysqli_fetch_array($qAdmin);
    if($ret>0){
      $_SESSION['agmsaid']=$result['ID'];
...
<head>
  <title>Login| Gallery Shop Management </title>  
