            ...
            <div class="about-sub-inner text-center mt-lg-4 mt-3">
               ...
               <div class="row">
                  <div class="col-lg-4 col-md-4 abut-gride">
                     ...
                     <h5>Shipping</h5>
                     <p class="mt-3"> We have a safe and reliable shipping system.
                  ...
                  <div class="col-lg-4 col-md-4 abut-gride">
                     ...
                     <h5>Support</h5>
                     <p class="mt-3"> You can inquire during working hours.
                  ...
                  <div class="col-lg-4 col-md-4 abut-gride">
                     ...
                     <h5> Return</h5>
                     <p class="mt-3">You can return defective or damaged products during delivery.
                     </p>
                  </div>
               </div>
            </div>
