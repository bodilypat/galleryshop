...
if(isset($_POST['send']))
  {
	...
	$eid=$_GET['eid'];
    $addInq=mysqli_query($con,"INSERT INTO tblenquiry(Artpdid,FullName,Email,MobileNumber,Message,EnquiryNumber)
...
<html lang="zxx">
   <head>
      <title>Gallery Shop Management | Art Enquiry</title>
   ...
   <body>
      ...
      <section class="contact py-lg-4 py-md-3 py-sm-3 py-3">
			 <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
					<h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Inquiry</h3>
