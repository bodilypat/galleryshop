...
?>
            ...
            <td><?php  echo $row['ArtMedium'];?></td>
                  ...
                  <td><a href="editArtMedium.php?editid=<?php echo $row['ID'];?>" class="btn btn-success">Edit</a> || <a href="manageMedium.php?delid=<?php echo $row['ID'];?>" class="btn btn-danger">Delete</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
