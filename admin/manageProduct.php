...
?>
            ...
            <td><?php  echo $row['Title'];?></td>
             <td><img src="images/<?php  echo $row['Image'];?>" width='100' height="100"></td>
                  ...
                  <td><a href="editArtProduct.php?editid=<?php echo $row['ID'];?>" class="btn btn-success">Edit</a> || <a href="manageProduct.php?delid=<?php echo $row['ID'];?>" class="btn btn-danger">Delete</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
