...
<head>
  ...
  <title>Manage Artist | Shop Gallery Management </title>
										...
										<table class="table">
												...
												<?php
													...
													<tr>
														  ...
														  <td><a href="editArtist.php?editid=<?php echo $row['ID'];?>" class="btn btn-success">Edit</a> || <a href="manageArtist.php?delid=<?php echo $row['ID'];?>" class="btn btn-danger">Delete</a></td>
													</tr>
													<?php 
														$cnt=$cnt+1;
													}
